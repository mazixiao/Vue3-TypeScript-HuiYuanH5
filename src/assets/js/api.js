...
export const EntryPage = () => {
  ...
  let md = mdCode.hexMD5('8888' + '100' + wMsgID + 'q1w2e3r4t5y6');
...
export const Home = () => {
  let formData = new FormData();
  let wMsgID = desCode.wMsgID();
  let md = mdCode.hexMD5('8888' + '101' + wMsgID + 'q1w2e3r4t5y6');
  formData.append('wAgent', 8888);
...
export const Hello = () => {
  let formData = new FormData();
  let wMsgID = desCode.wMsgID();
  let md = mdCode.hexMD5('8888' + '102' + wMsgID + 'q1w2e3r4t5y6');
  formData.append('wAgent', 8888);
...
export const HelloChildBanner = (params) => {
  let formData = new FormData();
  let wMsgID = desCode.wMsgID();
  let wParam = desCode.to3des(`bannerposition=${params.bannerposition}_typename=${params.typename}`);
...
export const AllBanner = (params) => {
  let formData = new FormData();
  let wMsgID = desCode.wMsgID();
  let wParam = desCode.to3des(`bannerposition=${params.bannerposition}`);
  let md = mdCode.hexMD5('8888' + '104' + wMsgID + wParam + 'q1w2e3r4t5y6');
  formData.append('wAgent', 8888);
...
export const AllContent = (params) => {
  let id = 0;
  ...
  let formData = new FormData();
  let wMsgID = desCode.wMsgID();
  let wParam = desCode.to3des(`typename=${params.typename}_sort=${params.sort}_id=${id}`);
...
export const Classify = (params) => {
  let formData = new FormData();
  let wMsgID = desCode.wMsgID();
  let wParam = desCode.to3des(`type=${params.type}`);
  let md = mdCode.hexMD5('8888' + '106' + wMsgID + wParam + 'q1w2e3r4t5y6');
  formData.append('wAgent', 8888);
...
export const NewsList = (params) => {
  let formData = new FormData();
  let wMsgID = desCode.wMsgID();
  let wParam = desCode.to3des(`id=${params.id}`);
  let md = mdCode.hexMD5('8888' + '107' + wMsgID + wParam + 'q1w2e3r4t5y6');
  formData.append('wAgent', 8888);
...
export const NewsDetail = (params) => {
  ...
  let wMsgID = desCode.wMsgID();
  let wParam = desCode.to3des(`id=${params.id}`);
  let md = mdCode.hexMD5('8888' + '108' + wMsgID + wParam + 'q1w2e3r4t5y6');
  formData.append('wAgent', 8888);
...
export const NewsListTop = () => {
  let formData = new FormData();
  let wMsgID = desCode.wMsgID();
  let md = mdCode.hexMD5('8888' + '109' + wMsgID + 'q1w2e3r4t5y6');
  formData.append('wAgent', 8888);
